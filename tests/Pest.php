...
pest()->extend(Outboard\Di\Tests\TestCase::class)->in('packages/dic/tests');
pest()->extend(Outboard\Framework\Tests\TestCase::class)->in('packages/framework/tests');
pest()->extend(Outboard\Wake\Tests\TestCase::class)->in('packages/wake/tests');
